...
# Variables
CPP  = clang++
OPTS = -g -Wall -W -Wunused -Wuninitialized -Wshadow
...
tests: test_default_ctor test_int_ctor test_c_str_ctor test_subscript test_times_10 test_times_single_digit test_multiply
	./test_default_ctor
	./test_int_ctor
	./test_c_str_ctor
	./test_add
